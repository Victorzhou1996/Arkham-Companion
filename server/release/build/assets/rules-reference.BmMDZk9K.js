import{d as e,g as t,p as n}from"./src.DEN_3V-D.js";import{$n as r,Lo as i,eo as a,er as o,f as s,h as c,ma as l,p as u,pi as d}from"./http-client.context.CDD_DG3I.js";import{B as f}from"./page-title.DdDVtrZX.js";import{i as p,l as ee}from"./card.EQs_3Oap.js";import{t as m}from"./chevron-left.NR52CPvl.js";import{i as h,n as g,t as _}from"./tabs.hooks.D1oiKeui.js";import{t as v}from"./search-input.CZiIqNgd.js";import{o as y,p as te}from"./index.DSPnmqk7.js";import{t as b}from"./plane.B_fNXF_F.js";import{c as x}from"./card-tooltip.D6-xAxrp.js";import{t as S}from"./markdown.9z832rcx.js";import{t as C}from"./use-go-back.COG-y_qP.js";import{i as w,n as T,r as ne,t as re}from"./tabs.B59mzsT5.js";var ie=c(`list`,[[`path`,{d:`M3 5h.01`,key:`18ugdj`}],[`path`,{d:`M3 12h.01`,key:`nlz23k`}],[`path`,{d:`M3 19h.01`,key:`noohij`}],[`path`,{d:`M8 5h13`,key:`1pao27`}],[`path`,{d:`M8 12h13`,key:`1za7za`}],[`path`,{d:`M8 19h13`,key:`m83p4d`}]]),E=t(n(),1),ae=`<nav class="toc" id="toc">
  <ul>
    <li>
...
`,D=e();function O({renderContent:e,renderToc:t,searchEnabled:n=!0}){let{t:r}=i(),o=C(),[c,u]=(0,E.useState)(``),[d,p]=(0,E.useState)(!1),h=(0,E.useDeferredValue)(c),g=(0,E.useRef)(null),_=(0,E.useRef)(null),y=(0,E.useRef)(null),b=(0,E.useCallback)(()=>{p(e=>!e)},[]),x=(0,E.useCallback)(()=>{p(!1)},[]);return(0,E.useEffect)(()=>{let e=()=>{p(!1),setTimeout(()=>{let e=window.location.hash.slice(1),t=document.getElementById(e);t&&t.scrollIntoView({behavior:`auto`})})};return window.addEventListener(`hashchange`,e),()=>{window.removeEventListener(`hashchange`,e)}},[]),f(`/`,()=>{n&&_.current?.focus()}),j(y,g,x,d),(0,D.jsxs)(`div`,{className:`container`,children:[(0,D.jsxs)(l,{className:`toc-toggle`,onClick:b,ref:g,size:`xl`,variant:`primary`,children:[d?(0,D.jsx)(te,{}):(0,D.jsx)(ie,{}),` `,r(`rules.toc`)]}),(0,D.jsxs)(`div`,{className:a(`toc-container`,d&&`open`),ref:y,children:[(0,D.jsx)(`h1`,{className:`toc-title`,children:r(`rules.toc`)}),n&&(0,D.jsx)(`div`,{className:`toc-search`,children:(0,D.jsx)(v,{className:`rules-search`,id:`rules-search`,onValueChange:u,placeholder:r(`rules.search_placeholder`),ref:_,value:c})}),(0,D.jsxs)(`nav`,{className:`toc-nav`,children:[(0,D.jsxs)(l,{size:`sm`,onClick:o,children:[(0,D.jsx)(m,{}),r(`common.back`)]}),(0,D.jsxs)(l,{size:`sm`,as:`a`,href:`#`,children:[(0,D.jsx)(ee,{}),r(`rules.back_to_top`)]})]}),(0,D.jsx)(s,{className:`toc-inner`,padded:!0,children:(0,D.jsx)(k,{renderToc:t,search:h})})]}),(0,D.jsx)(`div`,{className:`rules-container`,children:(0,D.jsx)(A,{renderContent:e,search:h})})]})}var k=(0,E.memo)(function({renderToc:e,search:t}){return e(t)}),A=(0,E.memo)(function({renderContent:e,search:t}){return e(t)});function j(e,t,n,r){(0,E.useEffect)(()=>{function i(i){r&&e.current&&!e.current.contains(i.target)&&i.target!==t.current&&!t.current?.contains(i.target)&&(i.preventDefault(),n())}return document.addEventListener(`pointerdown`,i),()=>{document.removeEventListener(`pointerdown`,i)}},[r,n,e,t])}function M(){let[e,t]=ae.split(`<!-- BEGIN RULES -->`);return(0,D.jsx)(O,{renderContent:()=>(0,D.jsx)(N,{rules:t}),renderToc:()=>(0,D.jsx)(`div`,{dangerouslySetInnerHTML:{__html:d(e,{newLines:`skip`})}}),searchEnabled:!1})}function N(e){let{rules:t}=e;return(0,D.jsx)(`div`,{dangerouslySetInnerHTML:{__html:d(t,{newLines:`skip`})}})}var P=`/assets/grimoire`;function F(e){return I(d(S(e),{newLines:`skip`}))}function I(e){let t=new DOMParser().parseFromString(e,`text/html`);for(let e of t.querySelectorAll(`img`)){let t=e.getAttribute(`src`);!t||!R(t)||(e.setAttribute(`src`,L(t)),e.setAttribute(`decoding`,`async`),e.setAttribute(`loading`,`lazy`))}return t.body.innerHTML}function L(e){return`${P}/${z(e)}`}function R(e){return!/^(?:[a-z]+:|\/\/|\/|#)/i.test(e.trim())}function z(e){return e.trim().replaceAll(`\\`,`/`).split(`/`).filter(e=>e&&e!==`.`&&e!==`..`).map(e=>encodeURIComponent(e)).join(`/`)}function B(e,t){return{entriesBySectionId:H(e),entrySearchTextById:W(e),sectionSearchTextById:G(t)}}function V(e,t,n,i){let a=r(i);if(!a||i.length<=2)return{entryIds:new Set(e.map(e=>e.id)),sectionIds:new Set(t.map(e=>e.id))};let o={entryIds:new Set,sectionIds:new Set};for(let t of e)a.test(n.entrySearchTextById.get(t.id)??``)&&(o.entryIds.add(t.id),o.sectionIds.add(t.section));for(let e of t)if(a.test(n.sectionSearchTextById.get(e.id)??``)){o.sectionIds.add(e.id);for(let t of n.entriesBySectionId.get(e.id)??[])o.entryIds.add(t.id)}return o}function H(e){let t=new Map;for(let n of e.toSorted((e,t)=>U(e.id,t.id))){let e=t.get(n.section)??[];e.push(n),t.set(n.section,e)}return t}function U(e,t){let n=e.split(`.`).map(e=>Number.parseInt(e,10)),r=t.split(`.`).map(e=>Number.parseInt(e,10)),i=Math.max(n.length,r.length);for(let a=0;a<i;a+=1){let i=n[a],o=r[a];if(Number.isNaN(i)||Number.isNaN(o))return e.localeCompare(t,void 0,{sensitivity:`base`});if(i!==o)return i-o}return e.localeCompare(t,void 0,{sensitivity:`base`})}function W(e){return new Map(e.map(e=>[e.id,K(e.title,e.text)]))}function G(e){return new Map(e.map(e=>[e.id,K(e.title,e.text)]))}function K(e,t){return o([e,t].filter(Boolean).join(` `))}function q(){let{t:e}=i(),t=p(),{cardLinkTooltip:n,referenceProps:r}=x();(0,E.useEffect)(()=>{if(t.isPending||t.error||!window.location.hash)return;let e=window.location.hash.slice(1);e.startsWith(`grimoire-`)&&requestAnimationFrame(()=>{let t=document.getElementById(e);t&&t.scrollIntoView({behavior:`auto`})})},[t.error,t.isPending]);let a=(0,E.useMemo)(()=>t.data?.entries??[],[t.data]),o=(0,E.useMemo)(()=>t.data?.sections??[],[t.data]),s=(0,E.useMemo)(()=>B(a,o),[a,o]),c=(0,E.useMemo)(()=>X(a,o),[a,o]),d=e=>V(a,o,s,e);return(0,D.jsx)(O,{renderContent:i=>{let a=d(i),f=!!a.sectionIds.size;return(0,D.jsxs)(`div`,{className:`grimoire longform`,...r,children:[(0,D.jsxs)(`div`,{className:`grimoire-header`,children:[(0,D.jsx)(`h1`,{children:e(`rules.grimoire.intro_title`)}),(0,D.jsx)(`p`,{children:e(`rules.grimoire.intro_description`)}),(0,D.jsxs)(l,{as:`a`,href:`https://ffgapp.com/qr/ahc100`,rel:`noreferrer`,size:`full`,target:`_blank`,variant:`primary`,children:[(0,D.jsx)(h,{}),e(`rules.grimoire.open_link`)]})]}),t.isPending&&(0,D.jsxs)(J,{children:[(0,D.jsx)(u,{className:`spin`}),e(`rules.grimoire.loading`)]}),t.error&&(0,D.jsx)(J,{children:e(`rules.grimoire.error`)}),f&&(0,D.jsx)(`div`,{className:`grimoire-list`,children:o.filter(e=>a.sectionIds.has(e.id)).map(e=>(0,D.jsx)(se,{filteredGrimoire:a,grimoireHtmlMaps:c,grimoireMaps:s,section:e},e.id))}),!f&&!t.isPending&&!t.error&&(0,D.jsx)(J,{children:e(`rules.grimoire.empty`)}),n]})},renderToc:e=>{let t=d(e);return t.sectionIds.size?(0,D.jsx)(`nav`,{className:`toc`,children:(0,D.jsx)(`ol`,{children:o.filter(e=>t.sectionIds.has(e.id)).map(e=>(0,D.jsx)(oe,{filteredGrimoire:t,grimoireHtmlMaps:c,grimoireMaps:s,section:e},e.id))})}):null}})}function J(e){let{children:t}=e;return(0,D.jsx)(`output`,{className:`grimoire-status`,children:t})}function oe(e){let{filteredGrimoire:t,grimoireHtmlMaps:n,grimoireMaps:r,section:i}=e,a=(r.entriesBySectionId.get(i.id)??[]).filter(e=>t.entryIds.has(e.id));return(0,D.jsxs)(`li`,{children:[(0,D.jsx)(Y,{href:`#${$(i.id)}`,html:n.sectionTitleById.get(i.id)??``}),!!a.length&&(0,D.jsx)(`ul`,{children:a.map(e=>(0,D.jsx)(`li`,{children:(0,D.jsx)(Y,{href:`#${Q(e.id)}`,html:n.entryTitleById.get(e.id)??``})},e.id))})]})}function se(e){let{filteredGrimoire:t,grimoireHtmlMaps:n,grimoireMaps:r,section:i}=e,a=(r.entriesBySectionId.get(i.id)??[]).filter(e=>t.entryIds.has(e.id)),o=n.sectionTextById.get(i.id)??``;return(0,D.jsxs)(`section`,{className:`grimoire-entry`,id:$(i.id),children:[(0,D.jsx)(ce,{html:n.sectionTitleById.get(i.id)??``,section:i}),(0,D.jsxs)(`div`,{className:`grimoire-entry-copy`,children:[o&&(0,D.jsx)(`div`,{className:`grimoire-text longform`,dangerouslySetInnerHTML:{__html:o}}),i.citation&&(0,D.jsx)(`p`,{children:(0,D.jsx)(g,{size:`sm`,children:i.citation})}),a.map(e=>(0,D.jsx)(le,{entry:e,grimoireHtmlMaps:n},e.id))]})]})}function ce(e){let{html:t,section:n}=e;return(0,D.jsx)(`h2`,{className:`grimoire-entry-title`,children:(0,D.jsx)(Y,{href:`#${$(n.id)}`,html:t})})}function le(e){let{t}=i(),{entry:n,grimoireHtmlMaps:r}=e,a=r.entryTextById.get(n.id)??``;return(0,D.jsxs)(b,{as:`article`,className:`grimoire-entry`,id:Q(n.id),children:[(0,D.jsx)(`h3`,{className:`grimoire-entry-title`,children:(0,D.jsx)(Y,{href:`#${Q(n.id)}`,html:r.entryTitleById.get(n.id)??``})}),(0,D.jsxs)(`div`,{className:`grimoire-entry-copy`,children:[a&&(0,D.jsx)(`div`,{className:`grimoire-text longform`,dangerouslySetInnerHTML:{__html:a}}),!!n.references?.length&&(0,D.jsxs)(`p`,{className:`grimoire-references`,children:[(0,D.jsxs)(`strong`,{children:[t(`rules.grimoire.references`),`:`]}),` `,(0,D.jsx)(`span`,{children:n.references.map((e,t)=>(0,D.jsxs)(E.Fragment,{children:[t>0?`, `:null,(0,D.jsx)(Y,{href:`#${Q(e)}`,html:r.entryTitleById.get(e)??Z(e)})]},e))})]}),(0,D.jsx)(`p`,{children:(0,D.jsx)(g,{size:`xs`,children:n.citation})})]})]})}function Y(e){let{href:t,html:n}=e;return(0,D.jsx)(`a`,{dangerouslySetInnerHTML:{__html:n},href:t})}function X(e,t){return{entryTextById:new Map(e.map(e=>[e.id,e.text?F(e.text):``])),entryTitleById:new Map(e.map(e=>[e.id,Z(e.title)])),sectionTextById:new Map(t.map(e=>[e.id,e.text?F(e.text):``])),sectionTitleById:new Map(t.map(e=>[e.id,Z(e.title)]))}}function Z(e){return d(e,{newLines:`skip`})}function Q(e){return`grimoire-entry-${encodeURIComponent(e)}`}function $(e){return`grimoire-section-${encodeURIComponent(e)}`}function ue(){let{t:e}=i(),[t,n]=_(`chapter_2`),r=(0,E.useCallback)(e=>{n(e)},[n]);return(0,E.useEffect)(()=>{window.location.hash.startsWith(`#grimoire-`)&&n(`chapter_2`)},[n]),(0,D.jsx)(y,{title:e(`rules.title`),children:(0,D.jsxs)(re,{value:t,onValueChange:r,children:[(0,D.jsxs)(ne,{children:[(0,D.jsx)(w,{value:`chapter_1`,onTabChange:r,children:e(`settings.collection.chapter`,{number:1})}),(0,D.jsx)(w,{value:`chapter_2`,onTabChange:r,children:e(`settings.collection.chapter`,{number:2})})]}),(0,D.jsx)(T,{value:`chapter_1`,children:(0,D.jsx)(M,{})}),(0,D.jsx)(T,{value:`chapter_2`,children:(0,D.jsx)(q,{})})]})})}export{ue as default};