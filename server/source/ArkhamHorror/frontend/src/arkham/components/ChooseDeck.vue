...
const filteredDecks = computed(() => {
  ...
  if (sortBy.value === 'name' || sortBy.value === 'class') {
    return sorted.sort((a, b) =>
      Number(b.id === recentDeckId.value) - Number(a.id === recentDeckId.value)
    )
  }
  return sorted
})
...
<template>
  <div class="container scroll-container site-workspace site-deck-picker">
