...
import Arkham.Campaign.Campaigns.TheScarletKeys.Achievements
...
instance RunMessage TheScarletKeys where
  runMessage msg c@(TheScarletKeys attrs) =
    runQueueT $ campaignI18n $ lift (runScarletKeysAchievements msg) *> case msg of
