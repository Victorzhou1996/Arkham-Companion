  ...
  build: {
    rollupOptions: {
      input: {
        ...
        legacyCustomCards: fileURLToPath(new URL('./src/legacy/customCards.ts', import.meta.url)),
      },
      output: { entryFileNames: chunk => chunk.name === 'legacyCustomCards' ? 'legacy-custom-cards-v20260921.js' : 'assets/[name]-[hash].js' },
    },
  },
  plugins: [
    vue(),
