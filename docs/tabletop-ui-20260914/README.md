...
**2026-09-15 增量已追加到同一分支。最新行为、Windows/Linux 组包与 Mac 接续请先看[当前源码交接](../release-source-20260915/README.md)。** 以下为 9 月 14 日首次提交的历史说明；金色呼吸、触屏先展开等描述已被独立手机布局、长按预览和有限橙红圆角框替代。
